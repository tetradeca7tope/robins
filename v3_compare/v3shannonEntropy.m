...
functionalName = 'Shannon Entropy 1D';
% And the distribution
distributionIndex = 2;

% Methods
% estimMethods = {'Plug-in'};
% estimMethods = {'Plug-in', 'DS', 'LOO'};
% estimMethods = {'Plug-in', 'DS', 'LOO', 'kNN', 'KDP', 'Voronoi', 'Edgeworth'};
estimMethods = {'Plug-in', 'DS', 'LOO', 'kNN', 'KDP', 'Vasicek-KDE'};
