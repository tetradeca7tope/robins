...
%           co.kNNmethod = 'knnFP1';
          ...
          estim = DKL_kNN_k_estimation(X', Y', co);

        case 'Szego'
          co.p_max = 1;
%           co.K = 1;
%           co = DKL_PSD_SzegoT_initialization(X', Y', co);
          estim = DKL_PSD_SzegoT_estimation(X', Y', co);
...
save(saveFileName, 'estimMethods', 'functional', 'methErrors', 'nCands', ...
  'numExperiments', 'numMethods', 'numNCands', 'functionalName', 'numDims');
